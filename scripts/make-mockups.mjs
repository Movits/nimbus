...
const NAME = {
  ...
  'B5-aparecida-halftone': 'Padroeira',
  'B7-fe-acima-de-tudo': 'Fé Acima de Tudo', 'B7-fe-acima-de-tudo-branco': 'Fé Acima de Tudo (branco)',
  'B8-deus-e-fiel': 'Deus é Fiel', 'B8-deus-e-fiel-preto': 'Deus é Fiel (preto)', 'B9-monograma-nmb': 'Monograma NMB',
