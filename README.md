...
é o ÚNICO ponto de entrada. Os documentos soltos que moravam nesta raiz
(precificação, roadmap, prompts, kit de marca) eram históricos e foram para
[`docs/historico/raiz/`](docs/historico/raiz/) em 11/08.
