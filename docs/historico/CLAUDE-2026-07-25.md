...
> [!warning] Ritual de ÉPOCA — não execute. A lista abaixo manda ler planos de
> 21/07 e a auditoria de 25/07 como "vigente"; hoje o roteiro de leitura é o do
> `docs/00-COMECE-AQUI.md` + `docs/ESTADO.md`, e nada deste arquivo deve ser
> seguido.
