...
# Crônica do estado, julho a 08/08/2026 (CONGELADA)

> [!warning] Esta é a crônica CONGELADA do antigo `docs/ESTADO.md` (769 linhas,
> última edição real em 04/08). **Nada daqui deve ser seguido**: o estado vivo
> é [`docs/ESTADO.md`](../ESTADO.md), reescrito em 11/08 como página curta.
> O valor daqui é o registro: cada bloco corrige os de cima, então uma linha
